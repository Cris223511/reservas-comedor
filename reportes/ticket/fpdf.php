...
class FPDF
{
	...
	function encabezado1($y, $logo, $ext_logo, $empresa, $num_comprobante, $fecha_hora, $tipo_comprobante, $estado)
	{
		# N° TICKET #
		$this->SetXY(3, $y);
	...
	function cuerpoReserva($y, $nombre_comedor, $titulo, $logo, $ext_logo, $fecha_hora_impresion, $codigo_reserva, $fecha_reserva, $fecha_registro, $estudiante, $codigo_estudiante, $estudiante_email, $estudiante_telefono, $facultad, $carrera, $menu, $menu_descripcion, $tipo_menu, $precio, $metodo_pago, $estado_pago, $estado_reserva, $observaciones)
	{
		...
		if ($estudiante && trim($estudiante) !== '') {
			$this->SetX(3);
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("ESTUDIANTE: $estudiante", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}

		if ($codigo_estudiante && trim($codigo_estudiante) !== '') {
			$this->Ln(2.5);
			$this->SetX(3);
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("CÓDIGO ESTUDIANTE: $codigo_estudiante", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}

		if ($estudiante_email && trim($estudiante_email) !== '') {
			$this->Ln(2.5);
			$this->SetX(3);
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("EMAIL: $estudiante_email", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}

		if ($estudiante_telefono && trim($estudiante_telefono) !== '') {
			$this->Ln(2.5);
			$this->SetX(3);
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("TELÉFONO: $estudiante_telefono", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}

		if ($facultad && trim($facultad) !== '') {
			$this->Ln(2.5);
			$this->SetX(3);
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("FACULTAD: $facultad", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}

		if ($carrera && trim($carrera) !== '') {
			$this->Ln(2.5);
			$this->SetX(3);
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("CARRERA: $carrera", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}
		...
		if ($menu && trim($menu) !== '') {
			...
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("MENÚ: $menu", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}

		if ($menu_descripcion && trim($menu_descripcion) !== '') {
			$this->Ln(2.5);
			$this->SetX(3);
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("DESCRIPCIÓN: $menu_descripcion", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}

		if ($tipo_menu && trim($tipo_menu) !== '') {
			$this->Ln(2.5);
			$this->SetX(3);
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("TIPO MENÚ: $tipo_menu", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}
		...
		$this->SetFont('hypermarket', '', 10);
		$this->SetTextColor(0, 0, 0);
		$this->MultiCell(0, 5, mb_convert_encoding("PRECIO: $precio", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		...
		if ($metodo_pago && trim($metodo_pago) !== '') {
			...
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("MÉTODO PAGO: $metodo_pago", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}
		...
		if ($observaciones && trim($observaciones) !== '') {
			...
			$this->SetFont('hypermarket', '', 7.5);
			$this->SetTextColor(0, 0, 0);
			$this->MultiCell(0, 3.5, mb_convert_encoding("OBSERVACIONES: $observaciones", 'ISO-8859-1', 'UTF-8'), 0, 'L', false);
		}
