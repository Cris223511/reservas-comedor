    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2025 <a href="escritorio.php" style="color: #002a8e;">Sistema de Reservas S.A.C</a>.</strong> Todos los derechos reservados.
    </footer>
    <!-- jQuery -->
    ...
    <script>
      function setTitleFromBoxTitle(titleElement) {
        ...
        document.title = fullTitle + " | Sistema de Reservas S.A.C.";
      }
